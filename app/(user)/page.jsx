...
const query = groq`
  *[_type=='category'] {
    ...,
    'post': *[_type=='post' && categories[0]._ref == ^._id]
}  
...
export default async function Home() {
  ...
  return (
    <main className="flex flex-col min-h-screen ">
      <div className="bg-yellow-500 px-12 h-[calc(100vh-theme(height.20))] flex flex-col justify-center">
        ...
        <Link
          href="#content"
          className="bg-zinc-900 p-3 mt-6 text-center md:self-start md:px-12"
        >
          Begin
        </Link>
      </div>
